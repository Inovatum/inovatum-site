...
interface ServicesBlockPreviewProps {
  gradient: { from: string; to: string } // Updated type
  displayIconColor: string
}

export const ServicesBlockPreview = ({ gradient, displayIconColor }: ServicesBlockPreviewProps) => {
  return (
    <motion.div
    ...
    >
      <Briefcase className="w-6 h-6 mb-2" style={{ color: displayIconColor }} />
